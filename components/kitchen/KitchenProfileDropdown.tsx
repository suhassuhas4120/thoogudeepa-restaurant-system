  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      <button
        ...
        className={`flex items-center gap-2 rounded-xl border px-2.5 py-1 transition shadow-2xs ${
          open
            ...
            <div className="p-3">
              {!confirmSignOut ? (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 rounded-xl bg-rose-600 hover:bg-rose-700 text-white py-2.5 font-mono text-xs font-black uppercase tracking-wider transition shadow-sm"
                >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 rounded-lg border border-slate-300 bg-stone-50 py-2 font-mono text-[10.5px] font-black text-slate-700 hover:bg-stone-100 transition"
                    >
                      CANCEL
                    </button>
                    <button
                      onClick={handleConfirmSignOut}
                      className="flex-1 rounded-lg bg-rose-600 hover:bg-rose-700 text-white py-2 font-mono text-[10.5px] font-black uppercase transition shadow-sm"
                    >
                      YES, SIGN OUT
                    </button>
                  </div>
